...
class ApplicationAssemblerStateTest
{
	...
	public function testBuildingStateTransitions() : Void
	{
		...
		this._applicationAssembler = FlowCompiler.compile( "context/flow/testBuildingStateTransitions.flow" );
		...
		Assert.equals( context, MockStateCommand.lastInjectedContext, "applicationContext should be the same" );
	}
	...
	public function testExtendingStateTransitions() : Void
	{
		...
		this._applicationAssembler = FlowCompiler.compile( "context/flow/testExtendingStateTransitions.flow" );
	...
	public function testCustomStateTransition() : Void
	{
		...
		this._applicationAssembler = FlowCompiler.compile( "context/flow/testCustomStateTransition.flow" );
